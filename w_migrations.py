...
with open("db/migrations/000001_create_initial_schema.up.sql", "w", encoding="utf-8", newline="\n") as f:
    f.write(up_sql)
...
with open("db/migrations/000001_create_initial_schema.down.sql", "w", encoding="utf-8", newline="\n") as f:
    f.write(down_sql)

print("Migrations SQL criadas")
