...
os.makedirs("internal/application/usecase", exist_ok=True)

with open("internal/application/usecase/errors.go", "w", encoding="utf-8", newline="\n") as f:
    f.write(errors_go)

with open("internal/application/usecase/common.go", "w", encoding="utf-8", newline="\n") as f:
    f.write(common_go)

print("errors.go e common.go criados")
