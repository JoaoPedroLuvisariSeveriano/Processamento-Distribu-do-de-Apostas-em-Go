...
os.makedirs("internal/domain/money", exist_ok=True)

money_go = textwrap.dedent('''\
...
with open("internal/domain/money/money.go", "w", encoding="utf-8", newline="\n") as f:
    f.write(money_go)

print("internal/domain/money/money.go criado")
