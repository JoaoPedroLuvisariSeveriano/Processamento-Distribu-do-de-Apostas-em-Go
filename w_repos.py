...
with open("internal/infrastructure/postgres/repositories.go", "w", encoding="utf-8", newline="\n") as f:
    f.write(ledger_outbox_inbox)

print("repositories.go criado (Ledger + Outbox + Inbox)")
